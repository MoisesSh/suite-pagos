...
class ValidacionAccesoServiceTests(APITestCase):
    def setUp(self):
        self.medio_pago = MedioPago.objects.create(codigo='C2P', nombre='Pago Móvil C2P')
        self.proveedor = ProveedorPago.objects.create(medio_pago=self.medio_pago, codigo='BDV', nombre='Banco de Venezuela')
...
class ValidarAccesoViewTests(APITestCase):
    def setUp(self):
        self.medio_pago = MedioPago.objects.create(codigo='C2P', nombre='Pago Móvil C2P')
        self.proveedor = ProveedorPago.objects.create(medio_pago=self.medio_pago, codigo='BDV', nombre='Banco de Venezuela')
        self.aplicacion = AplicacionRegistrada.objects.create(nombre='Conatel en Línea', app_origen_id=uuid.uuid4())
    ...
    def test_acceso_autorizado_responde_200(self):
